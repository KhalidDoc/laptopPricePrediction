              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-xs text-slate-500 mt-3">
                    A value of {metrics.r2} means the model explains{" "}
                    {(metrics.r2 * 100).toFixed(1)}% of market price variation.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-300">
                    Average prediction error in currency terms.
                  </p>

                  <p className="text-xs text-slate-500 mt-3">
                    On average, predictions deviate by ₹{" "}
                    {metrics.mae.toLocaleString()} from actual prices.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-slate-500 mt-3">
                    Higher difference between RMSE and MAE may indicate outliers
                    in the dataset.
                  </p>
                </div>
              </div>
